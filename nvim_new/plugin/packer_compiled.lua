...
_G.packer_plugins = {
  ...
  chadtree = {
    loaded = true,
    path = "/home/nate/.local/share/nvim/site/pack/packer/start/chadtree",
  ...
  ["gruvbox.nvim"] = {
    loaded = true,
    path = "/home/nate/.local/share/nvim/site/pack/packer/start/gruvbox.nvim",
  ...
  ["vim-airline"] = {
    loaded = true,
    path = "/home/nate/.local/share/nvim/site/pack/packer/start/vim-airline",
    url = "https://github.com/vim-airline/vim-airline"
  },
  ["vim-airline-themes"] = {
    loaded = true,
    path = "/home/nate/.local/share/nvim/site/pack/packer/start/vim-airline-themes",
